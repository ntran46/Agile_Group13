...
exports.Index = async function (request, res) {
...
exports.RegisterUser = async function (req, res) {
    ...
    let validatedUser = ValidateUserInfo(username, email, phone, password, passwordConfirm);
...
function ValidateUserInfo(username, email, phone, password, confirm) {
